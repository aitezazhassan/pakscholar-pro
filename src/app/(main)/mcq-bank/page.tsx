...
const subjects = [
    ...
    },
    {
        ...
        name: 'Geography',
        icon: Globe,
        description: 'Physical Geography, Water Bodies, Countries, Capitals, Mountains, Climate',
        questionCount: 18,
        topics: ['Physical Geography', 'Water Bodies', 'Countries', 'Mountains'],
    ...
    },
    {
        ...
        name: 'Computer',
        icon: Cpu,
        description: 'Software, Internet, Hardware, MS Office, Networking',
        questionCount: 5,
        topics: ['Software', 'Internet', 'Hardware'],
    ...
    },
    {
        ...
        name: 'Mathematics',
        icon: Calculator,
        description: 'Arithmetic, Algebra, Geometry, Statistics, Problem Solving',
        questionCount: 3,
    ...
    },
    {
        ...
        icon: Sparkles,
        description: 'Basic Islamic Knowledge, Prophets, Important Dates, Pillars of Islam',
        questionCount: 2,
        topics: ['Basic Knowledge', 'History'],
    ...
    },
    {
        ...
        name: 'Urdu',
        icon: Languages,
        description: 'Grammar (قواعد), Vocabulary, Comprehension',
        questionCount: 1,
        topics: ['Grammar'],
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center">
                        ...
                        <div className="flex justify-center gap-8 md:gap-12">
                            <div className="text-center">
                                <div className="text-4xl md:text-5xl font-bold text-emerald-400">{totalQuestions}</div>
                            ...
                            <div className="text-center">
                                ...
                                <div className="text-slate-400">Explained</div>
                            </div>
                        </div>
                    </div>
                </div>
