                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
                    ...
                    <div className="lg:col-span-1 space-y-8">
                        ...
                        <div className="flex gap-3">
                            {[Facebook, Twitter, Linkedin, Github].map((Icon, i) => (
                                <a key={i} href="#" className="w-10 h-10 bg-slate-900 border border-slate-800 hover:bg-emerald-600 hover:border-emerald-500 hover:text-white rounded-xl flex items-center justify-center transition-all duration-300 group">
                    ...
                    <div>
                        ...
                        <div className="flex flex-col gap-3">
                            ...
                            />
                            <button className="w-full px-6 py-3 bg-emerald-700 text-white rounded-xl font-bold hover:bg-emerald-600 transition-all shadow-lg shadow-emerald-900/20 active:scale-95">
                                Subscribe
                            </button>
                        </div>
                    </div>
